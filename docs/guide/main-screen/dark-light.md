...
The moon/sun button in the [My Apps](/guide/main-screen/my-apps) top bar toggles dark mode for the whole builder UI.
...
This controls the **builder's** appearance only. The apps you generate have their own theme settings (light/dark/follow-system) configured per app under [App Configuration](/guide/config/appearance).
