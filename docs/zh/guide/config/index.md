...
::: info 核心 vs 通用
非网页应用把编辑拆分为 **编辑核心配置**(类型专属的来源/运行时)和 **编辑通用配置**(下面的卡片)。网页应用在单一编辑器中显示这些。见[应用功能](/zh/guide/app-actions)。
:::
...
| **特殊设置** | 其他高级开关。 |
| **导出与权限** *(抽屉)* | 包名、版本、签名、运行时权限。见[应用功能](/zh/guide/app-actions#build-apk)。 |
