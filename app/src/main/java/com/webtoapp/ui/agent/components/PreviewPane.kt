...
fun PreviewTab(
    ...
    Row(
        ...
        Text(
            text = if (resolved == null) Strings.agentPreviewTabIdle
            else Strings.agentPreviewToolbarPrefix.format(resolved),
    ...
    Row(
        ...
        Box(modifier = Modifier.weight(1f)) {
            Row(
                ...
                Text(
                    text = previewFile ?: Strings.agentPreviewNoFile,
                    style = MaterialTheme.typography.labelMedium,
                    color = MaterialTheme.colorScheme.onSurface,
                ...
                if (previewables.isNotEmpty()) {
                    Icon(
                        ...
                        contentDescription = Strings.agentPreviewSwitchTooltip,
                        tint = MaterialTheme.colorScheme.onSurfaceVariant,
            ...
            DropdownMenu(
                ...
                Text(
                    text = Strings.agentPreviewSwitchHeader,
                    style = MaterialTheme.typography.labelMedium,
                ...
                if (previewables.isEmpty()) {
                    Text(
                        text = Strings.agentPreviewSwitchEmpty,
        ...
        if (errors > 0) {
            WtaInfoChip(
                label = Strings.agentPreviewErrorsCount.format(errors),
        ...
        if (warnings > 0) {
            WtaInfoChip(
                label = Strings.agentPreviewWarningsCount.format(warnings),
        ...
        WtaIconButton(
            ...
            contentDescription = Strings.agentPreviewRefresh
        )
    }
}
...
private fun EmptyPreview() {
    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                text = Strings.agentPreviewEmpty,
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
...
private fun previewableFiles(state: AgentUiState): List<ProjectFileManager.FileInfo> {
