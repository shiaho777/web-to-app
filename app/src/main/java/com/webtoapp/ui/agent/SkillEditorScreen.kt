...
import com.webtoapp.core.agent.skill.SkillEditorInput
import com.webtoapp.core.agent.skill.SkillLoader
import com.webtoapp.core.agent.skill.UserSkillRepository
...
fun SkillEditorScreen(
    ...
    fun validateName(input: String): String? {
        ...
        if (!Regex("^[a-z0-9]+(-[a-z0-9]+)*$").matches(input)) {
            return Strings.agentSkillNameInvalid
        }
        return null
    }
    ...
    fun doSave() {
        ...
        scope.launch {
            ...
            result.fold(
                onSuccess = {
                    snackbar.showSnackbar(Strings.agentSkillSaved.format(name))
                    onBack()
                },
                onFailure = { err ->
                    snackbar.showSnackbar(
                        Strings.agentSkillSaveFailed.format(err.message ?: "")
                    )
                }
            )
        }
    ...
    fun doDelete() {
        ...
        scope.launch {
            ...
            deleting = false
            if (ok) {
                snackbar.showSnackbar(Strings.agentSkillDeleted.format(target))
                onBack()
            } else {
                snackbar.showSnackbar(
                    Strings.agentSkillSaveFailed.format("")
                )
            }
        }
    }
    ...
    WtaScreen(
        title = if (isEditing) Strings.agentEditSkill else Strings.agentNewSkill,
        onBack = onBack,
        ...
        actions = {
            ...
            if (isEditing) {
                WtaIconButton(
                    ...
                    contentDescription = Strings.agentDeleteSkill,
        ...
        Column(
            ...
            WtaTextField(
                ...
                label = Strings.agentSkillNameLabel,
                placeholder = Strings.agentSkillNameHint,
            ...
            WtaTextField(
                ...
                label = Strings.agentSkillDescriptionLabel,
                singleLine = true,
                modifier = Modifier.fillMaxWidth()
            )
            WtaTextField(
                ...
                label = Strings.agentSkillWhenToUseLabel,
                placeholder = Strings.agentSkillWhenToUseHint,
                singleLine = true,
                modifier = Modifier.fillMaxWidth()
            )
            WtaTextField(
            ...
            WtaTextField(
                ...
                label = Strings.agentSkillBodyLabel,
                placeholder = Strings.agentSkillBodyHint,
                singleLine = false,
                maxLines = 30,
                modifier = Modifier
                    .fillMaxWidth()
            ...
            WtaButton(
                onClick = ::doSave,
                text = Strings.agentSaveAsAppConfirm,
                enabled = canSave,
    ...
    if (showDeleteConfirm) {
        WtaAlertDialog(
            ...
            icon = Icons.Outlined.Delete,
            title = Strings.agentDeleteSkill,
            text = Strings.agentSkillDeleteConfirm,
            confirmButton = {
                WtaButton(
                    onClick = {
            ...
            dismissButton = {
                WtaButton(
                    ...
                    text = Strings.agentActionCancel,
