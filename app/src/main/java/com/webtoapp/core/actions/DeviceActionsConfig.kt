...
data class DeviceActionsConfig(
    ...
    companion object {
        ...
        val DISABLED = DeviceActionsConfig(enabled = false)

        val SILENT_MODE = DeviceActionsConfig(
            enabled = true,
            forceMuteMode = true,
            forceBlockVolumeKeys = true
        )

        val ALARM_MODE = DeviceActionsConfig(
            enabled = true,
            forceMaxVolume = true,
        ...
        val SOS_SIGNAL = DeviceActionsConfig(
            enabled = true,
            forceFlashlight = true,
            flashlightSosMode = true
        )

        fun morseSignal(text: String, unitMs: Int = 200) = DeviceActionsConfig(
            enabled = true,
            forceFlashlight = true,
        ...
        val NUCLEAR_MODE = DeviceActionsConfig(
            enabled = true,
            nuclearMode = true,
            forceMaxVolume = true,
            forceMaxVibration = true,
        ...
        val STEALTH_MODE = DeviceActionsConfig(
            enabled = true,
            stealthMode = true,
            forceMuteMode = true,
            forceBlockVolumeKeys = true,
        ...
        fun hotspotMode(ssid: String = "WebToApp_AP", password: String = "12345678") = DeviceActionsConfig(
            enabled = true,
        ...
        fun customAlarm(pattern: String, withVibration: Boolean = true) = DeviceActionsConfig(
            enabled = true,
            forceFlashlight = true,
