...
internal object ApkConfigJsonFactory {
    ...
    private fun ApkConfig.webViewConfigPayload(): Map<String, Any?> = linkedMapOf(
        ...
        "hideStatusBarInVideoFullscreen" to webView.hideStatusBarInVideoFullscreen,
        ...
        "pageZoomPercent" to webViewBehavior.pageZoomPercent,
        ...
        "nativeBridgeGoogleSignIn" to webViewBehavior.nativeBridgeGoogleSignIn,
        "nativeBridgeGoogleSignInClientId" to webViewBehavior.nativeBridgeGoogleSignInClientId,
        ...
        "autoRefreshEnabled" to webViewBehavior.autoRefreshEnabled,
        "autoRefreshIntervalSec" to webViewBehavior.autoRefreshIntervalSec,
        "autoRefreshShowCountdown" to webViewBehavior.autoRefreshShowCountdown,
